package edu.miu.cs.cs489.lab7.adsdentalsurgery;

import edu.miu.cs.cs489.lab7.adsdentalsurgery.model.*;
...
import edu.miu.cs.cs489.lab7.adsdentalsurgery.service.*;
...
public class AdsdentalsurgeryApplication implements CommandLineRunner {
    ...
    public AdsdentalsurgeryApplication(AddressService addressService,
    ...
    public void run(String... args) throws Exception {
        ...
        // Save address and use managed instance
        Address a1 = new Address(null, "123 Main St", "Waterloo", "ON", "N2L3G1");
        Address savedAddress = addressService.save(a1);

        // Use the managed address
        Patient p1 = new Patient(null, "Alice", "Smith", savedAddress);
        patientService.save(p1);

        Dentist d1 = new Dentist(null, "Dr. John", "Doe", "General Dentist");
        dentistService.save(d1);

        Surgery s1 = new Surgery(null, "Downtown Surgery", savedAddress);
